...
urlpatterns = [
    path('search/<str:product_name>/<int:page_number>/', views.product_search, name='product_search'),
    path('search/lprice/<str:product_name>/', views.product_lprice, name='product_lprice'),
